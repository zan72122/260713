...
export const FLAVORS = [
  { id: 'straw',   color: [0.96, 0.36, 0.47], drip: '#f45c78', body: '#ff8aa0' }, // いちご(赤)
  { id: 'soda',    color: [0.32, 0.58, 0.95], drip: '#3a7bd5', body: '#6fa8ff' }, // ソーダ(青)
  { id: 'vanilla', color: [0.99, 0.96, 0.87], drip: '#e8ddb8', body: '#fdf6e0' }, // バニラ(白)
  { id: 'mango',   color: [1.00, 0.78, 0.25], drip: '#f0a818', body: '#ffcf59' }, // マンゴー(黄)
  { id: 'choco',   color: [0.42, 0.26, 0.16], drip: '#4a2c18', body: '#7a4a2a' }, // チョコ(茶)
];
